...
void PostProcessingShader::setShaderParameters(BasicShaderParameters basicShaderParameters, ID3D11ShaderResourceView* glowPostProcessing)
{
	HRESULT result;
	...
	basicShaderParameters.deviceContext->PSSetShaderResources(0, 1, &(basicShaderParameters.texture)); // processed scene (before post-process)
	basicShaderParameters.deviceContext->PSSetShaderResources(1, 1, &glowPostProcessing); // glow texture (post process)
